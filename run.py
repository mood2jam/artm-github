...
parser.add_argument('--num_epochs', '-e', type=int, help='number of epochs', default=15)
...
parser.add_argument('--show_plots', '-p', type=bool, help='show histograms, confusion matricies, and images throughout training', default=False)
